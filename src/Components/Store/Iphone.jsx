...
const PRODUCTS = [
  {
    ...
    image:
      "https://i.pinimg.com/originals/74/ed/6a/74ed6a5afdaeac95371d6de24afcb716.png",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/59/f8/aa/59f8aaf221ed2404bddb14b61d47bed3.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/5e/fa/b6/5efab697bccfddab13ec2d4d262b02ec.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/9d/08/51/9d0851a1422117b18ddb1f925f75df8d.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/58/06/ff/5806ff82cfd27a05ebbf3d3e493f162f.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/1200x/8c/cb/4d/8ccb4d9eb1f8f664326b2813bf607797.jpg",
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/736x/53/c3/71/53c371651b8c8a2f2b9414e2416a9f48.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/2b/4e/2d/2b4e2d1821f4b3f50dcf94430bbc3c0d.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/24/57/77/2457778e56d891f4b0cc73d498ae647a.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/77/39/83/773983dd12472a8e321cdbf74e952528.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/1200x/a5/a8/2f/a5a82f2019d448cbb900331ce726e90e.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/ba/0e/f4/ba0ef4f259b71eecab1784150a994112.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/1200x/51/ad/f3/51adf327343f44f700cfdc8433cac0ab.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/1200x/73/94/cb/7394cb093abc66d681640fff65dcf30a.jpg",
...

  {
    ...
    image:
      "https://i.pinimg.com/736x/6f/c9/1a/6fc91a20112ccd7e584b807077f71333.jpg",
  ...
  return (
    <div className="iphone-card">
      <div className="iphone-image-box">
        ...
        <img src={product.image} alt={product.name} className="iphone-image" />
      </div>

      <div className="iphone-info">
        <span className="iphone-category">{product.category}</span>

        <p className="iphone-name">{product.name}</p>

        <p className="iphone-desc">{product.desc}</p>
        ...
        <div className="color-dots">
          {product.colors.map((color, index) => (
            <button
              key={index}
              className={
                activeColor === index ? "color-dot active" : "color-dot"
              }
        ...
        <div className="iphone-bottom">
          <span className="iphone-price">{product.price}</span>
    ...
    <div className="store-wrapper">
      <section className="hero">
        <div className="hero-content">
          <p className="hero-eyebrow">Summer 2025 Drop</p>
          ...
          <p className="hero-sub">
            The latest iPhones. Bold colors, titanium builds, and a camera that
            outthinks the moment.
          </p>

          <div className="hero-buttons">
            <button className="btn btn-primary">Shop Now</button>

            <button className="btn btn-outline">Explore Models</button>
          </div>
        </div>
      </section>
      ...
      <section className="iphone-section">
        <div className="section-heading">
          ...
          <p>Find the model that fits your life — and your budget.</p>
        </div>
